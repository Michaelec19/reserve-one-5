          ...
          <form id="scheduleForm">
            <div class="mb-3">
              ...
              <select class="form-select" id="modality" name="modality" required>
                ...
                <option value="grupal" ${schedule?.modality === 'grupal' ? 'selected' : ''}>Grupal</option>
                <option value="personalizada" ${schedule?.modality === 'personalizada' ? 'selected' : ''}>Personalizada</option>
              </select>
            </div>
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="idCatalog" name="idCatalog" required>
                ...
                <!-- Aquí idealmente cargas dinámicamente las opciones desde tu API de Catálogo, o dejas los IDs numéricos correspondientes -->
                <option value="1">Rutina</option>
                <option value="2">Combate</option>
                <option value="3">Acondicionamiento</option>
                <option value="4">Taichí</option>
              </select>
            </div>
